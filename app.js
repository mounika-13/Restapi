...
const mongoUrl = "mongodb+srv://mounika-13:Mounika@2001@mycluster.bvcvh.mongodb.net/mydatabase?retryWrites=true&w=majority";
...
app.get('/',(req,res) => {
    res.send("<div><a href='http://localhost:1300/location'>Location</a><br/><a href='http://localhost:1300/mealtype'>MealType</a><br/><a href='http://localhost:1300/cuisine'>Cuisine</a><br/><a href='http://localhost:1300/restaurant'>Restaurant</a></div>")
})
